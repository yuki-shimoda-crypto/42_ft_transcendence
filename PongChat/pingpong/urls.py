...
urlpatterns = [
    ...
    path("multiplayer_play_local", views.multiplayer_play_local, name="multiplayer_play_local",),
    path("multiplayer_play_remote/<str:game_id>", views.multiplayer_play_remote, name="multiplayer_play_remote",),
    ...
    path("tournament_registration", views.tournament_registration, name="tournament_registration",),
]
